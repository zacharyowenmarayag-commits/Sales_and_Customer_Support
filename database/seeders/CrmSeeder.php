...
class CrmSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $mockFollowUps = [
            [
                'log_id' => 1,
                'task' => 'Call Sarah Jenkins',
                'customer' => 'Sarah Jenkins',
                'due' => Carbon::now()->setHour(13)->setMinute(0)->toISOString(),
                'status' => 'Pending',
                'priority' => 'High',
                'description' => 'Call Sarah Jenkins to discuss the new proposal and answer any questions regarding the services.',
                'created_by' => 'AmbatuGrowOfficial',
                'created_at' => Carbon::now()->subDay()->setHour(10)->setMinute(15)->toISOString(),
            ],
            [
                'log_id' => 3,
                'task' => 'Prepare Q3 Report',
                'customer' => 'Jollipop Foods Corporation',
                'due' => Carbon::now()->setHour(13)->setMinute(30)->toISOString(),
                'status' => 'Pending',
                'priority' => 'Medium',
                'description' => 'Compile and prepare the Q3 performance report for Jollipop Foods Corporation ahead of the review meeting.',
                'created_by' => 'AmbatuGrowOfficial',
                'created_at' => Carbon::now()->subDay()->setHour(10)->setMinute(15)->toISOString(),
            ],
            [
                'log_id' => 2,
                'task' => 'Meeting with TechCorp',
                'customer' => 'TechCorp Solutions',
                'due' => Carbon::now()->setHour(15)->setMinute(0)->toISOString(),
                'status' => 'Pending',
                'priority' => 'High',
                'description' => 'In-person meeting with TechCorp team to review current SLA and handle queries.',
                'created_by' => 'AmbatuGrowOfficial',
            ...
            [
                ...
                'customer' => 'Nova Corp',
                'due' => Carbon::tomorrow()->toISOString(),
                'status' => 'Pending',
                'priority' => 'Low',
                'description' => 'Send follow up email to Nova Corp with requested details.',
                'created_by' => 'Admin',
            ...
            [
                ...
                'due' => Carbon::now()->setHour(16)->setMinute(30)->toISOString(),
                'status' => 'Pending',
                'priority' => 'Medium',
                'description' => 'Sync up with SM Retail team for progress update.',
                'created_by' => 'Admin',
                'created_at' => Carbon::now()->toISOString(),
            ],
            [
                'log_id' => 5,
                'task' => 'Renew Contract - Nova Corp',
                'customer' => 'Nova Corp',
                'due' => Carbon::now()->next(Carbon::FRIDAY)->setHour(10)->setMinute(0)->toISOString(),
                'status' => 'Pending',
                'priority' => 'High',
                'description' => 'Discussion and sign-off on the contract renewal documents with Nova Corp.',
                'created_by' => 'AmbatuGrowOfficial',
                'created_at' => Carbon::now()->subDays(2)->toISOString(),
            ],
            [
                'log_id' => 5,
                'task' => 'Send Proposal to Nova Corp',
                'customer' => 'Nova Corp',
                'due' => Carbon::now()->subDays(2)->toISOString(),
                'status' => 'Completed',
                'priority' => 'High',
                'description' => 'Prepare and send the draft proposal to Nova Corp team.',
                'created_by' => 'AmbatuGrowOfficial',
                'created_at' => Carbon::now()->subDays(4)->toISOString(),
            ],
            [
                'log_id' => 6,
                'task' => 'Onboard New Client - BrightRetail',
                'customer' => 'BrightRetail Group',
                'due' => Carbon::now()->subDays(5)->toISOString(),
                'status' => 'Completed',
                'priority' => 'Medium',
                'description' => 'Setup and run onboarding presentation and provide resources.',
                'created_by' => 'AmbatuGrowOfficial',
